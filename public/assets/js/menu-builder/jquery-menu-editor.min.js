    ...
    i.sortableLists(r.listOptions), c.on("change", function(e) {
        ...
        e.preventDefault(),
            function(e) {
                ...
                $.each(s, function(e, s) {
                    a.find("[name=" + e + "]").val(s)
                }), a.find(".item-menu").first().focus(), 
                s.hasOwnProperty("icon") ? $('#icons-apply').html(feather.toSvg(s.icon)) : $('#icons-apply').html('');
        ...
        if (null !== e) {
            ...
            e.children().children("svg").removeClass(s).addClass(e.data("icon")).html(feather.toSvg(e.data("icon"))), 
            e.find("span.txt").first().text(e.data("text")), d()
        }
    }, this.add = function() {
        if(!$('#textname').val()){
            $('#textname').addClass('border-danger')
            return false
        }
        $('#icons-apply').html('')
        var e = {};
        ...
        if (null !== s) {
            ...
            var t = function d(e, s) {
                ...
                return $.each(e, function(e, s) {
                    ...
                    var o = $("<li>").addClass("list-group-item");
                    o.data(l);
                    var i = $("<div>").css("overflow", "auto"),
                        r = s.icon ? feather.toSvg(s.icon) : '',
